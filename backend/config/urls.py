...
from places.views import ManagedMediaView, PrivateBusinessClaimAttachmentView, PrivateBusinessProfileMediaView
...
urlpatterns = [
    ...
    path('private-business-profile-media/<uuid:media_id>/', PrivateBusinessProfileMediaView.as_view(), name='private-business-profile-media'),
