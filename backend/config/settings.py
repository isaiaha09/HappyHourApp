...
RENDER_API_KEY = get_env('DD_DB_API_KEY', ENV_VALUES, '').strip()
RENDER_POSTGRES_ID = get_env('RENDER_POSTGRES_ID', ENV_VALUES, '').strip()
RENDER_STORAGE_ENABLED = get_bool_env('RENDER_STORAGE_ENABLED', ENV_VALUES, IS_RENDER)
RENDER_STORAGE_CACHE_TIMEOUT = get_int_env('RENDER_STORAGE_CACHE_TIMEOUT', ENV_VALUES, 300)
RENDER_METRICS_TIMEOUT_SECONDS = get_int_env('RENDER_METRICS_TIMEOUT_SECONDS', ENV_VALUES, 2)
...
VERIFICATION_PDF_MAX_FILES = get_int_env('VERIFICATION_PDF_MAX_FILES', ENV_VALUES, 8)
VERIFICATION_PDF_MAX_AGGREGATE_BYTES = get_int_env(
	'VERIFICATION_PDF_MAX_AGGREGATE_BYTES',
	ENV_VALUES,
	20 * 1024 * 1024,
)
...
CLOUDMERSIVE_VIRUS_SCAN_TIMEOUT_SECONDS = get_int_env('CLOUDMERSIVE_VIRUS_SCAN_TIMEOUT_SECONDS', ENV_VALUES, 15)
CLOUDMERSIVE_VIRUS_SCAN_FAILURE_MODE = get_env('CLOUDMERSIVE_VIRUS_SCAN_FAILURE_MODE', ENV_VALUES, 'allow').strip().lower()
if CLOUDMERSIVE_VIRUS_SCAN_FAILURE_MODE not in {'allow', 'block'}:
	CLOUDMERSIVE_VIRUS_SCAN_FAILURE_MODE = 'allow'
VERIFICATION_PDF_MAX_PAGES = get_int_env('VERIFICATION_PDF_MAX_PAGES', ENV_VALUES, 50)
VERIFICATION_PDF_MAX_EXTRACTED_TEXT_BYTES = get_int_env(
	'VERIFICATION_PDF_MAX_EXTRACTED_TEXT_BYTES',
	ENV_VALUES,
	1_000_000,
)
...
BUSINESS_CLAIM_RETRY_CODE_TTL_SECONDS = get_int_env('BUSINESS_CLAIM_RETRY_CODE_TTL_SECONDS', ENV_VALUES, 600)
