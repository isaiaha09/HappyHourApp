...
from places.models import AccountProfile, BusinessClaim, BusinessClaimRetryGrant, BusinessMembership, BusinessPost, ContentReport, FavoriteBusiness, FavoriteBusinessNotification, FavoriteBusinessPushDevice, HappyHourNotificationDelivery, ProfileAuthToken, SponsoredCampaign, VenueType
...
def build_account_response(user, portal, claim=None, token=None):
	...
	return {
		...
		'direct_message_notifications_enabled': profile.direct_message_notifications_enabled,
		'business_updates_notifications_enabled': profile.business_updates_notifications_enabled,
		'happy_hour_notifications_enabled': profile.happy_hour_notifications_enabled,
