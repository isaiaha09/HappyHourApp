...
class ListingSnapshot(models.Model):
	...
	imported_image_urls = models.JSONField(default=list, blank=True)
	suppressed_imported_image_urls = models.JSONField(default=list, blank=True)
	...
	deal_overrides_cleared = models.BooleanField(default=False)
...
class AccountProfile(models.Model):
	...
	direct_message_notifications_enabled = models.BooleanField(default=False)
	business_updates_notifications_enabled = models.BooleanField(default=False)
