...
from .views import (
    ...
    BusinessSignupView,
    BusinessClaimRetryRequestView,
    BusinessClaimRetryCodeVerifyView,
    ContactSupportView,
    ContentReportView,
    CustomerSignupView,
...
urlpatterns = [
    ...
    path('places/live-locations/', LiveLocationPlaceListView.as_view(), name='place-live-locations'),
    path('places/current-happy-hours/', CurrentHappyHoursView.as_view(), name='place-current-happy-hours'),
    ...
    path('profiles/logout/', LogoutView.as_view(), name='profile-logout'),
    ...
    path('profiles/business-claim-retry-request/', BusinessClaimRetryRequestView.as_view(), name='profile-business-claim-retry-request'),
    path('profiles/business-claim-retry-verify/', BusinessClaimRetryCodeVerifyView.as_view(), name='profile-business-claim-retry-verify'),
    ...
    path('profiles/direct-messages/images/<int:message_id>/', DirectMessageImageView.as_view(), name='profile-direct-message-image'),
