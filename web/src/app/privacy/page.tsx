...
const privacySections: readonly PrivacySectionData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Preferences and activity: favorite businesses, notification settings, preferred cities, days and time periods, notification delivery history, session keys, request IDs, and similar records needed to operate the Service.",
      ...
      "Support and communications information: information in emails or support requests, business-claim review emails, verification messages, password-reset messages, and reports sent to the support team. When you submit the web contact form, the information you enter is screened for abuse and sent to the configured support inbox; replies are directed to the email address you provide. If that email matches a non-deleted account, the support message may include its account type, username, and associated business name and type.",
      "Payment information: The current release does not offer paid content, subscriptions, purchases, checkout, billing portal access, or payment processing, so DiningDealz does not collect payment information or connect to a payment provider for this release.",
    ],
  },
  {
    title: "3. Where information comes from",
    paragraphs: ["We receive information from you, from your device or browser, from other people who use the Service (for example, a direct-message participant or report submitter), from business representatives and authorized reviewers, from public or licensed business-data sources, and from service providers that process information for us. We may also create information from these sources, such as account status, verification results, notification history, safety decisions, and deletion or retention records."],
  },
  {
    ...
    items: [
      "Providing and personalizing the Service, including account creation, authentication, nearby discovery, favorites, business profiles, deals, happy-hour features, direct messaging, and business tools.",
      ...
      "Operating, troubleshooting, monitoring, testing, maintaining, and improving the Service. The current release does not offer sponsored campaign features or cross-app behavioral advertising.",
  ...
  },
  {
    ...
    items: [
      "Service providers that host or secure the app, website, database, private/public media storage, email delivery, bot protection, error monitoring, mapping/geocoding, or push notifications. No payment provider or billing service is connected to the current release. Providers may process technical information under their own privacy notices and contractual instructions.",
  ...
  },
  {
    ...
    paragraphs: [`Based on the current Service configuration and operational records reviewed as of ${EFFECTIVE_DATE}, DiningDealz has not sold personal information or shared it for cross-context behavioral advertising in the preceding 12 months. The Service does not currently use an advertising network, data broker, IDFA-based ad measurement, cross-app behavioral tracking SDK, or sponsored campaign feature.`, "If we introduce a practice that qualifies as a sale, sharing, targeted advertising, or tracking under applicable law, we will update this Policy, provide required notices and controls, and request device permission where required before using that practice."],
  },
  {
    ...
    items: [
      ...
      "Public business content remains available while published. Deletion removes user-managed posts, profile photos, attachments, and publication references where applicable; source or directory information supplied by third parties may remain or be republished independently of a deleted account.",
  ...
  },
  {
    ...
    items: [
      ...
      "Commercial and transaction-related information, such as saved businesses and offer interactions.",
      "Internet or other electronic network activity, such as sign-in activity, request IDs, and app or website diagnostics.",
