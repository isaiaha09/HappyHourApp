...
RCT_EXPORT_VIEW_PROPERTY(onCalendarPress, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onSharePress, RCTDirectEventBlock)
...
RCT_EXPORT_VIEW_PROPERTY(showFavoriteActions, BOOL)
RCT_EXPORT_VIEW_PROPERTY(theme, NSString)
RCT_EXPORT_VIEW_PROPERTY(userLatitude, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(userLongitude, NSNumber)
