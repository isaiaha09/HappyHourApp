...
function AppScreen() {
      ...
      : incomingOnboardingScreen && screenMode === 'browse'
        ...
        : incomingOnboardingScreen === 'splash' && currentOnboardingScreen !== null && guestOnboardingOrigin === 'browse'
          ...
          : currentOnboardingScreen !== null && guestOnboardingOrigin === 'browse'
            ? 0
            : 1;
  const guestBrowseNativeTabMaterialFadeIn = incomingOnboardingScreen === 'splash'
      ...
      <View style={[
        ...
        >
          {renderBrowseScreen({
            ...
            guestChromeNativeTabMaterialFadeIn: guestBrowseNativeTabMaterialFadeIn,
            suppressBrowseSceneTransitionStyle: true,
            suppressScreenTransitionStyle: true,
            suppressTransitionOverlay: true,
          })}
    ...
    return wrapScreenWithInteractiveBackSwipe(interactiveSwipeTarget, (
      <View style={[styles.fullScreenRoot, transitionActive ? styles.transitionClipRoot : null]}>
        <Animated.View
          ...
          style={[styles.screenTransitionLayerAbsolute, profileLayerStyle, profileStackTransitionActive ? (onboardingTransitionAxis === 'x' ? currentHorizontalOnboardingTransitionStyle : currentOnboardingTransitionStyle) : null]}
        >
          {profileLayerContent}
        </Animated.View>
  ...
  function renderBrowseScreen(options?: {
    ...
    guestChromeNativeTabMaterialFadeIn?: boolean;
          ...
          <View style={styles.fullScreenRoot}>
            ...
            {options?.guestChrome ? (
              <GuestShellChrome
                ...
                nativeTabMaterialFadeIn={options.guestChromeNativeTabMaterialFadeIn}
