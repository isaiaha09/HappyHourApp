...
export const termsOfServiceSections: ReadonlyArray<LegalDocumentSection> = [
  {
    ...
    body: 'These Terms of Service and Agreements govern your access to and use of the DiningDealz app, website, account dashboard, business tools, messaging features, and related services. By accessing or using the Service, creating an account, or continuing after an update becomes effective, you agree to these Terms and the Privacy Policy. If you do not agree, do not use the Service. A separate written agreement, insertion order, checkout page, or feature-specific terms control a paid or business transaction if they conflict with these Terms. The current version took effect on August 30, 2026.',
  },
  {
  ...
  },
  {
    ...
    body: 'DiningDealz may display listings, locations, hours, deals, happy-hour information, public posts, notifications, and sponsored content from businesses, source data, and providers. Information may be incomplete, delayed, changed, unavailable, or wrong; a map pin or live location may be approximate. Unless a separate checkout expressly says otherwise, DiningDealz does not sell food, drinks, alcohol, products, admissions, reservations, or merchant services and is not a party to your transaction with a business. Confirm prices, hours, restrictions, availability, allergens, taxes, fees, age requirements, and redemption rules directly with the business. Businesses are solely responsible for their listings, offers, services, licenses, taxes, age verification, health and safety, and fulfillment. A listing, verification badge, or sponsored placement is not an endorsement or guarantee.',
  },
  {
  ...
  },
  {
    ...
    body: 'DiningDealz may send transactional messages about verification, password resets, support, direct messages, account security, claims, and service changes. Optional push notifications about favorites, offers, business updates, or happy-hour activity can be controlled in the app or device settings. If sponsored campaigns are enabled, they may be labeled and measured with first-party impression, click, open, save, or share records; sponsored placement is not an endorsement. If a paid feature is offered, the applicable checkout, billing portal, insertion order, or feature-specific terms will state price, billing frequency, renewal, cancellation, refund, taxes, and payment provider. Those terms control that transaction.',
  },
  {
    title: '11. Privacy and third parties',
    body: 'The Privacy Policy explains how information is collected, used, shared, retained, and deleted. The Service may link to or interoperate with app stores, maps, calendars, social platforms, email apps, hosting/storage, notification, security, monitoring, data-source, and payment providers. Those parties control their own services and notices. DiningDealz is not responsible for third-party content, availability, security, privacy, purchases, or disputes. Review third-party terms before using an external feature.',
  },
  {
