...
export const venueFilters = [
  ...
  { label: 'Mobile Vendor', value: 'mobile' },
...
export const multipleAreasBusinessCityOption = { label: 'Serves Multiple Locations', value: 'multiple_areas' } as const;
...
export function getBrowseSummaryLabel(
  ...
  if (options.favoriteBusinessesOnly) {
    summaryParts.push('Favorite Businesses');
  }
